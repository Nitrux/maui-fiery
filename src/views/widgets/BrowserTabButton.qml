    ...
    contentItem: MouseArea
    {
        ...
        RowLayout
        {
            ...
            Loader
            {
                ...
                {
                    opacity: control.closeButtonVisible ? (Maui.Handy.isMobile ? 1 : (control.hovered || control.checked ? 1 : 0)) : 0
                    padding: 0
                    ...
                    enabled: control.closeButtonVisible
                    onClicked: if (control.closeButtonVisible) control.closeClicked()
